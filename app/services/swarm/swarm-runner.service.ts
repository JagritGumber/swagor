...
- The payload includes deterministic marketFeatures computed by code, plus compact recentCandles and openInterestDeltas. Use them together to reason about candle patterns and volume/open-interest relationships. Use featureQuality to judge whether those facts are reliable.
