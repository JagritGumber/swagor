...
export const PlanCompilerSchema = z.object({
  ...
  // The compiler input includes trendRegime for context, but the model
  // must not be the source of truth for it. plan-compiler.service.ts
  // re-attaches the deterministic trendRegime after parsing.
  trendRegime: z.preprocess(() => undefined, TrendRegimeSchema.optional()),
