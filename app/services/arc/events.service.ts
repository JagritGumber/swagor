...
/**
 * Gather a user's most-recent Arc anchor events across three sources:
 * trade opens, trade closes, and watcher decisions (execute / risk_emergency).
 * Existing closed trades with on-chain hashes already backfilled by Circle
 * are included naturally; no migration required.
 */
