...
export const regimeBadgeClass: Record<ReaderMarketRegimeMode, ReturnType<typeof css>> = {
  'range': s.regimeRange,
...
export const stanceBadgeClass: Record<LiveReaderStance, ReturnType<typeof css>> = {
  'wait': s.stanceWait,
