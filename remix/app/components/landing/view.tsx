...
import { LandingChartEntry } from './chart-entry.tsx'
import * as s from './style.ts'

interface LandingAuction {
  location: string
...
export function LandingView(handle: Handle<LandingViewProps>) {
  return () => {
