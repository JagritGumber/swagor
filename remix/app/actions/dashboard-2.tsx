// Dashboard-2 action — auth-gated, returns template data
import { redirect } from 'remix/response/redirect'
import { Auth } from 'remix/middleware/auth'
import type { AppContext } from '../router.ts'
import { DashboardPage } from '../pages/dashboard-2/page.tsx'
import type { DashboardData } from '../pages/dashboard-2/types.ts'
...
export async function dashboard2(context: AppContext) {
