...
> **Sister submission — Arc OSS.** Same author also submitted [Tangent](https://github.com/JagritGumber/arc-perp-reference) (repo slug `arc-perp-reference`) to the Arc Open Source Showcase: a forkable, MIT-licensed open-source perpetual-futures DEX reference for Arc Testnet, **deployed live** on 2026-05-25 ([AccountManager](https://testnet.arcscan.app/address/0x2b1ca7ca0a883cd162c619b4a74f0942b22c0e40), [USDCVault](https://testnet.arcscan.app/address/0xa4d41df0ad7c420c19c971772e57469459204833), [MarketRegistry](https://testnet.arcscan.app/address/0x96a6e69af20ae3a52e164373c345e0a47f23ead2)). Built because Selbo hit the Shapeshifter / CMDT ClearingHouse wall during this hackathon and the gap is real. A circle is the locus of arcs; a tangent is the line that meets one. Independent repos, independent submissions, complementary tracks: Selbo is the consumer-facing autonomous agent, Tangent is the missing on-chain infrastructure primitive any future Arc agent builder would target.
