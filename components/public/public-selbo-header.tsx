  ...
  return (
    <header className="border border-[var(--hairline-strong)] bg-black p-8">
      ...
      <div className="mt-4 grid gap-6 sm:grid-cols-2">
        <div>
          <div className="font-mono text-xs uppercase tracking-[0.16em] text-muted-foreground">Equity</div>
          <div className="mt-1 font-mono text-4xl tabular-nums text-foreground">${balance.toFixed(2)}</div>
